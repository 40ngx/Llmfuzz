...
// pub const CODEX_MODEL: &str = "gpt-3.5-turbo-0613";
// pub const CODEX_MODEL: &str = "mistral/codestral";
pub const CODEX_MODEL: &str = "/root/Meta-Llama-3.1-70B-Instruct";
// pub const CODEX_MODEL: &str = "codestral";
// pub const CODEX_MODEL: &str = "gpt-4o-mini";

// pub const CHATGPT_MODEL: &str = "gpt-3.5-turbo-0613";
// pub const CHATGPT_MODEL: &str = "gpt-4o";
// pub const CHATGPT_MODEL: &str = "mistral/codestral";
pub const CHATGPT_MODEL: &str = "/root/Meta-Llama-3.1-70B-Instruct";
// pub const CHATGPT_MODEL: &str = "codestral";
// pub const CHATGPT_MODEL: &str = "gpt-4o-mini";
...
// pub const CHATGPT_MODEL_LONG: &str = "gpt-3.5-turbo-0613";
// pub const CHATGPT_MODEL_LONG: &str = "mistral/codestral";
pub const CHATGPT_MODEL_LONG: &str = "/root/Meta-Llama-3.1-70B-Instruct";
// pub const CHATGPT_MODEL_LONG: &str = "codestral";
// pub const CHATGPT_MODEL_LONG: &str = "gpt-4o-mini";
...
pub const GPT4_MODEL: &str = "gpt-3.5-turbo-0613";
...
pub const FUZZER_FLAGS: [&str; 5] = ["-fsanitize=fuzzer",
    "-O1", 
    "-g",
    "-fsanitize=address,undefined", 
    "-ftrivial-auto-var-init=zero",
...
pub const COVERAGE_FLAGS: [&str; 9] = ["-g", 
    "-fsanitize=fuzzer", 
